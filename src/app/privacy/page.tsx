...
const DESCRIPTION =
  "السياسة الرسمية للخصوصية وحماية البيانات في JEMO LABS: تشفير حركة البيانات، حظر المشاركة الإعلانية، وحقوق التصدير والمحو النهائي.";
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "يمكنك تقديم طلب مباشر عبر إعدادات الحساب أو مراسلة مسؤول حماية البيانات (privacy@jemo.co) وسيتم مسح جميع سجلاتك خلال شهر.",
          },
        },
        {
          "@type": "Question",
...
const PRIVACY_SECTIONS: PrivacySection[] = [
  ...
  },
  {
    ...
    clauses: [
      ...
      },
      {
        ...
        body: "إرسال إشعارات الأمان الضرورية وتحديثات السياسات. لا توجد فواتير — لا نبيع خدمات. لا نرسل أي رسائل دعائية دون موافقة مسبقة.",
      },
    ],
  },
  {
    ...
    icon: Lock,
    highlight: "تشفير TLS 1.3 أثناء النقل، وAES-256 في السكون. لا نحمل شهادات (SOC 2 / ISO 27001) حالياً؛ نعتمد على ضوابط مزودينا المعتمدين وممارسات أمان داخلية.",
    clauses: [
      {
        code: "4.1",
      ...
      {
        code: "4.3",
        title: "المراقبة الدورية والفحص الأمني",
        body: "إجراء فحوصات وتحديثات دورية لمكتبات النظام ومتابعة التحذيرات الأمنية لضمان متانة الحماية.",
      },
    ],
  },
  {
    ...
    clauses: [
      ...
      },
      {
        ...
        body: "تتم معالجة البيانات واستضافتها عبر مزودي بنية معتمدين: Cloudflare (الاستضافة والشبكة الطرفية)، Supabase (قاعدة البيانات والتخزين)، Clerk (إدارة الجلسات والتوثيق)، Resend (البريد الإشعاري)، وتليجرام (تنبيهات الإدارة).",
        mandatory: true,
      },
      {
        code: "5.3",
  ...
  },
  {
    ...
    icon: UserCheck,
    highlight: "حق كامل في تصدير البيانات، تصحيح السجلات، والمحو النهائي التام (الحق في النسيان) خلال شهر.",
    clauses: [
      {
        code: "6.1",
      ...
      },
      {
        ...
        body: "لك الحق في طلب حذف حسابك وبياناتك بالكامل من خوادمنا، ويتم تنفيذ المسح التام والنهائي خلال شهر من تاريخ الطلب.",
        mandatory: true,
      },
      {
        code: "6.3",
...
const KEY_PILLARS = [
  ...
  },
  {
    ...
    desc: "إمكانية تحميل كامل بياناتك بصيغة معيارية أو طلب حذفها نهائياً خلال شهر.",
  },
  {
    icon: ShieldCheck,
            ...
            <div className="lg:col-span-8 space-y-12 sm:space-y-16">
              ...
              >
                <div className="space-y-2">
                  ...
                  <p className="text-xs sm:text-sm text-[var(--ink-2)] leading-relaxed">
                    نلتزم بالرد على كافة طلبات الخصوصية، استفسارات حماية البيانات، وإجراءات ممارسة حقوقك الرقمية
                    خلال مهلة أقصاها 30 يوماً.
                  </p>
                </div>
