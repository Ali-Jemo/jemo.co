...
const DESCRIPTION =
  "الشروط والأحكام الرسمية الحاكمة لمنصة ومختبرات JEMO LABS: حماية الملكية الفكرية، سرية البيانات، وسياسات الاستخدام المسؤول للأبحاث والأنظمة.";
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "نعم، يمكنك في أي وقت طلب تصدير كامل بياناتك أو المسح النهائي لجميع سجلاتك من خوادمنا خلال شهر وفق سياسة الخصوصية.",
          },
        },
        {
          "@type": "Question",
          "name": "هل يوجد أي رسوم أو اشتراكات مدفوعة؟",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "لا. المنصة مجانية للاستخدام البحثي ولا توجد باقات مدفوعة. أي دعم مالي هو تبرع طوعي غير مسترد لإبقاء المختبر يعمل.",
          },
        },
        {
          "@type": "Question",
...
const SECTIONS: TermSection[] = [
  ...
  },
  {
    id: "sla",
    number: "05",
    title: "مستوى الخدمة — مختبر بحثي غير تجاري",
    icon: Server,
    highlight: "نبذل جهداً أفضل (best-effort). لا ضمانات تشغيل تجارية ولا تعويضات انقطاع.",
    clauses: [
      {
        code: "5.1",
        title: "جهد أفضل دون التزامات تجارية",
        body: "JEMO LABS مختبر بحثي مستقل غير ربحي. نشغّل المنصة بجهد أفضل دون أي التزام بنسبة جاهزية أو إشعار صيانة ملزم.",
        mandatory: true,
      },
      {
        code: "5.2",
  ...
  },
  {
    id: "billing",
    number: "06",
    title: "لا مبيعات — الدعم تبرع لإبقاء المختبر يعمل",
    icon: CreditCard,
    highlight: "لا نبيع خدمات ولا اشتراكات. أي دعم مالي هو تبرع غير مسترد لإبقاء المختبر يعمل.",
    clauses: [
      {
        code: "6.1",
        title: "لا خطط ولا فوترة",
        body: "لا توجد باقات مدفوعة ولا رسوم ولا تجديد تلقائي. المنصة مجانية للاستخدام البحثي.",
        mandatory: true,
      },
      {
        code: "6.2",
        title: "التبرعات غير مستردة",
        body: "المساهمات المالية عبر صفحة الدعم تبرعات طوعية غير مستردة مخصصة لتكاليف التشغيل (استضافة، نطاقات، أدوات). لا تمنح أي حقوق ملكية أو أولوية خدمة.",
        mandatory: true,
      },
      {
        code: "6.3",
        title: "شفافية الاستخدام",
        body: "نلتزم بتوضيح أوجه استخدام الدعم بشكل عام عبر قنوات المختبر، دون التزامات تقارير مدققة.",
      },
    ],
  },
  {
...
const FAQS = [
  ...
  },
  {
    ...
    a: "نعم، يمكنك في أي وقت تصدير كافة مشاريعك بصيغة معيارية (JSON/ZIP) أو طلب الحذف النهائي لجميع سجلاتك وحسابك خلال شهر وفق سياسة الخصوصية وحماية البيانات.",
  },
  {
    q: "هل يوجد أي رسوم أو اشتراكات مدفوعة؟",
    a: "لا. المنصة مجانية للاستخدام البحثي. الدعم المالي تبرع طوعي غير مسترد لإبقاء المختبر يعمل ولا يمنح أي حقوق أو أولوية.",
  },
  {
...
const KEY_PILLARS = [
  ...
  },
  {
    icon: Server,
    badge: "Best Effort",
    title: "تشغيل بجهد أفضل",
    desc: "مختبر بحثي غير ربحي يشغّل المنصة بجهد أفضل دون التزامات تجارية.",
  },
  {
    icon: HeartHandshake,
    badge: "Non-profit Lab",
    title: "دعم لإبقاء المختبر يعمل",
    desc: "المساهمات تبرعات طوعية غير مستردة لتكاليف التشغيل.",
  },
];
