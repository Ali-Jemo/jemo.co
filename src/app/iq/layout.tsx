...
export default function IqLayout({
  ...
  return (
    <div className="iq-theme dark min-h-screen bg-[#080c0d] text-[#f7f7f5] flex flex-col font-sans selection:bg-[#bef264] selection:text-[#0c1415]" dir="rtl">
      {/* Top Universal Bridge Bar to Jemo Labs */}
      <header className="sticky top-0 z-40 w-full bg-[#0c1415] opacity-95 backdrop-blur-md border-b border-white/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-3">
          
          {/* Right: App Brand & Slogan */}
          <div className="flex items-center gap-3">
            <Link href="/iq" className="flex items-center gap-2 group">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-[#bef264] to-[#a3e635] text-[#0c1415] flex items-center justify-center font-mono font-black text-sm shadow-md group-hover:scale-105 transition-transform">
                هـ
              </div>
              <div className="flex flex-col">
                <div className="flex items-center gap-1.5">
                  <span className="font-kufi font-black text-base text-white tracking-tight leading-none group-hover:text-[var(--gold)] transition-colors">
                    هسه
                  </span>
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/"
              className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-white/15 bg-white/5 hover:bg-white/10 text-white/80 hover:text-[var(--gold)] text-[11px] font-mono transition-all group"
            ...
            >
              ...
              <span className="font-bold text-white group-hover:text-[var(--gold)]">JEMO LABS</span>
