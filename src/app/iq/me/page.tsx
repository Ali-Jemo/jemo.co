...
export default function IqMePage() {
  ...
  return (
    <div className="space-y-6 sm:space-y-8 max-w-3xl mx-auto">
      ...
      <section className="p-5 sm:p-6 rounded-3xl bg-[var(--surface)] border border-white/10 shadow-lg flex items-center justify-between gap-4">
        <div className="flex items-center gap-3.5">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-[var(--gold)] to-[var(--accent-tint)] text-[var(--surface)] font-kufi font-black text-xl flex items-center justify-center shadow-md">
            ع
          </div>
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-2 py-0.5 rounded-full bg-[var(--gold)]/10 text-[var(--gold)] border border-[var(--gold)]/20 text-[10px] font-mono font-bold flex items-center gap-1">
        ...
        <Link
          href="/"
          className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full border border-white/10 bg-white/5 hover:bg-white/10 text-white/80 hover:text-[var(--gold)] text-xs font-mono transition-colors"
        >
      ...
      <form onSubmit={handleSave} className="p-5 sm:p-6 rounded-3xl bg-[var(--surface)] border border-white/10 shadow-lg space-y-5">
        <div className="flex items-center gap-2 pb-3 border-b border-white/10 font-kufi font-bold text-white text-base">
          <SlidersHorizontal className="w-4 h-4 text-[var(--gold)]" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-mono">
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full h-11 px-3 bg-[var(--surface-2)] border border-white/15 focus:border-[var(--gold)] rounded-xl text-white outline-none"
            >
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full h-11 px-3.5 bg-black/40 border border-white/15 focus:border-[var(--gold)] rounded-xl text-white outline-none"
            />
          </div>
        </div>
        ...
        <div className="pt-2 flex items-center justify-between">
          ...
          <button
            type="submit"
            className="px-6 py-2.5 rounded-full bg-[var(--gold)] hover:bg-[var(--accent-tint)] text-[var(--surface)] font-kufi font-bold text-xs shadow-md transition-all active:scale-95 cursor-pointer"
          >
            حفظ التفضيلات
          </button>
        </div>
      ...
      <section className="p-5 sm:p-6 rounded-3xl bg-[var(--surface)] border border-white/10 shadow-lg space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-white/10">
          <div className="flex items-center gap-2 font-kufi font-bold text-white text-base">
            <Bookmark className="w-4 h-4 text-[var(--gold)]" />
        ...
        <div className="space-y-2.5">
          <div className="p-3 rounded-xl bg-white/[0.02] border border-white/5 flex items-center justify-between text-xs font-mono">
            ...
            <Link href="/iq/intel" className="text-[var(--gold)] hover:underline">
              عرض الدليل ←
            </Link>
          </div>
          <div className="p-3 rounded-xl bg-white/[0.02] border border-white/5 flex items-center justify-between text-xs font-mono">
            <span className="text-white/90">ورشة المهندس لتصليح السبالت (رقم الواتساب مسجل)</span>
            <Link href="/iq/map" className="text-[var(--gold)] hover:underline">
              عرض في الخريطة ←
            </Link>
          </div>
        </div>
