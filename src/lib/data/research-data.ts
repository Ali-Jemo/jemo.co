...
export const RESEARCH_PAPERS: Paper[] = [
  {
    ...
    title: "كيف ساعد الذكاء الاصطناعي في بناء التقويم الرافديني؟",
    titleEn: "How AI Helped Build the Rafidain Calendar",
    abstract: "دراسة عملية عن بناء تقويم رافديني تجريبي بمساعدة الذكاء الاصطناعي. تشرح كيف تحولت الفكرة إلى مواصفة ومكتبات برمجية وواجهة عربية، وما الذي تحقق فعلاً، وما الذي يحتاج إلى مراجعة بشرية قبل تقديم النظام كمعتمد.",
    authors: [
  ...
  type={Research Note}
    ...
    question: "هل يستطيع الذكاء الاصطناعي تحويل فكرة تقويم جديدة إلى نموذج يعمل ويمكن فحصه؟ وأين يتوقف دوره ويبدأ التحقق البشري؟",
    toolsUsed: ["الذكاء الاصطناعي في البرمجة", "Python", "JavaScript", "HTML/CSS", "اختبارات ذاتية"],
    promptWorkflow: "بدأنا بمواصفة تحدد قواعد التقويم، ثم طلبنا تنفيذها في Python وJavaScript، وبعدها واجهة عربية، وأخيراً اختبارات تتحقق من تواريخ ثابتة. في كل مرحلة راجعنا النتيجة مقابل المواصفة والملفات الفعلية.",
    methodology: "فحصنا وثيقة المشروع ومكتبتي Python وJavaScript وملفات الواجهة، ثم شغّلنا الفحصين الذاتيين يوم 25 أيلول 2026. شملت الفحوص: 7 أيلول 2026 = 19 الحصيدة 2773 RF، ورأس السنة في 22 آذار 2026، والتحويل ذهاباً وإياباً، ويوم بداية كل شهر، وقاعدة السنة الكبيسة.",
    findings: "ساعد الذكاء الاصطناعي في تحويل فكرة كبيرة إلى نموذج قابل للتشغيل: مواصفة، ومكتبة Python، ومكتبة JavaScript، وواجهة عربية. لكنه لم يثبت أن التقويم صحيح فلكياً أو قانونياً. وأهم ما كشفته المراجعة البشرية هو تكرار بعض الخوارزميات، وادعاءات تظهر في النصوص دون دليل واضح في الكود.",
    humanVerification: {
      accuracyCheck: "نجحت فحوص Python وJavaScript. راجعناها يدوياً، وتأكدنا من التواريخ الأساسية والتحويل العكسي وقاعدة الكبس. كما قارنّا ادعاءات الواجهة بما هو موجود فعلاً في المشروع.",
      hallucinationCorrected: "أزلنا الاعتماد على ادعاءات لا يوجد لها تنفيذ واضح، مثل التكاملات أو الجاهزية المؤسسية. نجاح الاختبارات لا يعني أن النظام معتمد، بل يعني أن القواعد البرمجية التي اختبرناها تعطي النتائج المتوقعة.",
      confidence: "استكشافية / أولية"
    },
    researchTrail: [
      { step: "1. كتبنا القاعدة", note: "وثيقة واحدة تحدد بداية السنة، وأيامها، والشهر الكبيس وطريقة التحويل." },
      { step: "2. نحوّلها إلى كود", note: "كتبنا النسخة نفسها بالـ Python وJavaScript حتى يسهل فحصها ومقارنتها." },
      { step: "3. جعلناها قابلة للتجربة", note: "بنينا واجهة عربية لتحويل التاريخ وعرض التقويم، ثم راجعنا عملها على المتصفح." },
      { step: "4. اختبرنا ما يمكن اختباره", note: "شغّلنا أمثلة ثابتة وراجعنا النتائج. ما لا يمكن اختباره تلقائياً بقي سؤالاً مفتوحاً." }
    ],
    limitations: "هذه دراسة عن نموذج أولي، وليست دليلاً على اعتماد تقويم. لم ننفّذ بعد تحققاً فلكياً أو قانونياً مستقلاً، ولا اختبار استخدام مع أشخاص. كما توجد نسخ مكررة من بعض الحسابات داخل الواجهة، وتوحيدها خطوة تالية.",
    metrics: {
      reproducedCount: 0,
