...
export default function SupportFAQ() {
  const faqItems = [
    ...
    },
    {
      ...
      children: (
        <p className="text-xs sm:text-sm text-[var(--ink-2)] leading-relaxed">
          نعم بالتأكيد. يمكنك عند التبرع عبر العملات الرقمية أو الحوالة البنكية أو النموذج الإشارة إلى أنك ترغب في توجيه مساهمتك إلى: أبحاث أنظمة التشغيل والنوى، مختبر الذكاء الاصطناعي ومعالجة اللغة العربية، أو مختبر العتاد السيادي وRISC-V.
        </p>
      ),
    },
    {
      ...
      children: (
        <p className="text-xs sm:text-sm text-[var(--ink-2)] leading-relaxed">
          تعد العملات الرقمية (وخاصة USDT على شبكة TRC-20 أو شبكة Base/Arbitrum) ومنصة GitHub Sponsors أسهل الطرق وأسرعها، نظراً لغياب الوسطاء المصرفيين والعمولات البنكية المعقدة وسرعة وصول الموارد المباشرة لحسابات المختبر.
        </p>
      ),
    },
    {
    ...
    },
    {
      ...
      children: (
        <p className="text-xs sm:text-sm text-[var(--ink-2)] leading-relaxed">
          نعم. نوفر للمؤسسات الأكاديمية والشركات الراعية مذكرات تفاهم (MOU)، اتفاقيات رعاية بحثية معتمدة، إيصالات استلام موثقة، وتقارير أثر دورية مدققة توضح بدقة كيف تم استثمار المنحة في دعم الأبحاث.
        </p>
      ),
    },
  ];
