    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-start justify-center pt-3 sm:pt-20 px-2.5 sm:px-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          ...
          />
          <div className="relative w-full max-w-2xl bg-[var(--bg)] border border-[var(--line)] rounded-2xl shadow-2xl overflow-hidden z-10 font-sans max-h-[85vh] flex flex-col animate-[palette-in_0.3s_cubic-bezier(0.16,1,0.3,1)_both]">
            {/* Search Input Bar */}
                ...
                results.map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <ArrowLeft className="w-4 h-4 text-[var(--brand)] shrink-0 opacity-0 group-hover:opacity-100 transition-opacity" />
                    </div>
                  );
                })
              )}
