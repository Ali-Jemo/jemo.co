...
export default function GlowButton({ children, className = "", href }: GlowButtonProps) {
  ...
  return (
    ...
    >
      {/* Outer Glow */}
      <span className="absolute -inset-1 rounded-full bg-gradient-to-r from-[var(--brand)] via-[var(--accent)] to-[var(--brand-700)] opacity-30 blur-md transition-all duration-500 group-hover:opacity-80 group-hover:blur-lg" />
