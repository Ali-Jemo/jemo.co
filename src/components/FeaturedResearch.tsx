      ...
      <div className="w-full">
          {filtered.length === 1 ? (
            ...
            <article
              ...
              data-cohere-item=""
              style={cohereDelay(0)}
              className="p-6 sm:p-10 rounded-2xl sm:rounded-3xl border border-[#e4e3e3] bg-white shadow-xs hover:border-[#a7e26e] transition-all flex flex-col justify-between"
            >
              <div>
                <div
                className="flex items-center justify-between gap-3 mb-4 sm:mb-6 flex-wrap"
                data-cohere-item=""
                style={cohereDelay(50)}
              >
                ...
                <h3
                  className="text-xl sm:text-3xl lg:text-4xl font-bold leading-tight text-[#222f30] mb-3"
                  data-cohere-item=""
                  style={cohereDelay(100)}
                >
                ...
                <p
                  className="text-xs sm:text-sm font-mono text-[#738284] mb-4 dir-ltr text-right"
                  data-cohere-item=""
                  style={cohereDelay(140)}
                >
                  {hero.titleEn}
                </p>
                <p
                  className="text-sm sm:text-base text-[#55696a] leading-relaxed max-w-4xl"
                  data-cohere-item=""
                  style={cohereDelay(180)}
                >
                  {hero.abstract}
                </p>
              </div>
              ...
              <div
                className="pt-6 mt-8 border-t border-[#e4e3e3] flex flex-wrap items-center justify-between gap-4"
                data-cohere-item=""
              ...
              >
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  >
                    ...
                    <ArrowUpLeft className="cohere-arrow w-4 h-4 transition-transform duration-200 group-hover:-translate-x-0.5 group-hover:-translate-y-0.5" />
                  </Link>
                </div>
              </div>
            </article>
            ...
            <RevealGroup className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-6 items-stretch">
              {[hero, rest[0]].map((p, i) => (
                <article
                  key={p.id}
                  data-cohere-card=""
                  data-cohere-item=""
                  style={cohereDelay(i * 100)}
                ...
                >
                  <div>
                    ...
                    <h3
                      className="text-lg sm:text-2xl font-bold leading-snug text-[#222f30] mb-2"
                      data-cohere-item=""
                    ...
                    <p
                      className="text-xs font-mono text-[#738284] mb-3 dir-ltr text-right"
                      data-cohere-item=""
                      style={cohereDelay(i * 100 + 140)}
                    >
                      {p.titleEn}
                    </p>
                    <p
                      className="text-xs sm:text-sm text-[#55696a] leading-relaxed line-clamp-3 sm:line-clamp-4"
                      data-cohere-item=""
                      style={cohereDelay(i * 100 + 180)}
                    >
                      {p.abstract}
                    </p>
                  </div>
                  ...
                  <div
                    className="pt-5 mt-6 border-t border-[#e4e3e3] flex items-center justify-between gap-3 flex-wrap"
                    data-cohere-item=""
                    style={cohereDelay(i * 100 + 220)}
                  >
            ...
            <RevealGroup className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-6 items-stretch">
              {/* Hero Paper (Spans 2 columns) */}
              <article
                data-cohere-card=""
                data-cohere-item=""
                style={cohereDelay(0)}
                className="lg:col-span-2 p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-[#e4e3e3] bg-white shadow-xs hover:border-[#a7e26e] transition-all flex flex-col justify-between"
              >
                <div>
                  <div
                    className="flex items-center justify-between gap-3 mb-4 sm:mb-5 min-h-[28px] flex-wrap"
                    data-cohere-item=""
                    style={cohereDelay(50)}
                  >
                    <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <h3
                    className="text-lg sm:text-2xl md:text-3xl font-bold leading-snug text-[#222f30] mb-2"
                    data-cohere-item=""
                    style={cohereDelay(100)}
                  >
                    <Link href={`/research/${hero.slug}`} className="hover:text-[#445e5f] transition-colors">
                  ...
                  <p
                    className="text-[11px] sm:text-xs font-mono text-[#738284] mb-3 sm:mb-4 dir-ltr text-right"
                    data-cohere-item=""
                    style={cohereDelay(140)}
                  >
                    {hero.titleEn}
                ...
                <div>
                  <div
                    className="flex items-center gap-2 text-xs text-[#55696a] mb-4"
                    data-cohere-item=""
                    style={cohereDelay(220)}
                  >
                    <Users className="w-3.5 h-3.5 text-[#a7e26e]" />
                  ...
                  <div
                    className="flex flex-wrap items-center justify-between gap-3 pt-4 border-t border-[#e4e3e3]"
                    data-cohere-item=""
                    style={cohereDelay(260)}
                  >
                    <Link
                      href={`/research/${hero.slug}`}
                      className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-lg bg-[#222f30] text-[#cef79e] hover:bg-[#162224] hover:text-white text-xs font-mono font-bold transition-all shadow-xs group"
              ...
              <div className="lg:col-span-1 flex flex-col gap-4 sm:gap-5">
                {rest.map((p, i) => (
                  ...
                  >
                    <div>
                      <div
                        className="flex items-center justify-between gap-2 mb-3 min-h-[26px]"
                        data-cohere-item=""
                        style={cohereDelay((i + 1) * 100 + 50)}
                      >
                      ...
                      <h3
                        className="text-base font-bold text-[#222f30] mb-2 leading-snug"
                        data-cohere-item=""
                        style={cohereDelay((i + 1) * 100 + 100)}
                      >
                        <Link href={`/research/${p.slug}`} className="hover:text-[#445e5f] transition-colors">
                          {p.title}
                        </Link>
                      ...
                      <p
                        className="text-xs text-[#55696a] leading-relaxed line-clamp-2"
                        data-cohere-item=""
                        style={cohereDelay((i + 1) * 100 + 150)}
                      >
                        {p.abstract}
                      </p>
                    </div>
                    ...
                    <div
                      className="pt-3 mt-4 border-t border-[#e4e3e3]"
                      data-cohere-item=""
                      style={cohereDelay((i + 1) * 100 + 200)}
                    >
                      <Link
                        href={`/research/${p.slug}`}
                      ...
                      >
                        <span>عرض سجل الاكتشاف</span>
                        <ArrowUpLeft className="cohere-arrow w-3.5 h-3.5 text-[#738284] group-hover:text-[#222f30] transition-transform duration-200 group-hover:-translate-x-0.5 group-hover:-translate-y-0.5" />
                      </Link>
                    </div>
                  </article>
                ))}
