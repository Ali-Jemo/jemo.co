...
const paragraphs = [
  "من واقع شغف عميق بهندسة النوى والبرمجة منخفضة المستوى، انطلقت الرؤية لبناء بدائل سيادية مفتوحة المصدر تبدأ من مستوى العتاد والنواة وتصل إلى واجهات المستخدم والتطبيقات الذكية.",
  "في عام ٢٠٢٦، أطلقنا JEMO LABS كمظلة بحثية وتوثيقية حاضنة لمشاريع مثل ZiqaKernel و Axiq-IQ ومبادرة ++IRAQ، لنثبت عملياً أن العالم العربي والعراق قادران على هندسة أنظمة تشغيل ونوى برمجية وطنية متكاملة ومفتوحة المصدر.",
  "نعمل بشفافية مطلقة ونؤمن بأن كفاءة العمل وتأثيره البرمجي (Proof of Work) هما المعيار الحقيقي. ندعوكم لاستكشاف مستودعاتنا البرمجية ومشاركتنا بناء هذا المستقبل.",
];
...
const quoteWords = "السيادة التقنية هي امتلاك صلاحيات الأدمن على مستقبلنا — نبني برمجياتنا من مستوى النواة.".split(" ");

const marqueeText = "بيت الحكمة الرقمي · JEMO LABS · البحث العلمي المفتوح · السيادة الرقمية · ZIQAKERNEL · AXIQ-IQ · ++IRAQ · ";
