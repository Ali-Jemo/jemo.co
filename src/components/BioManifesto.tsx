      ...
      <div className="max-w-[1440px] mx-auto grid lg:grid-cols-[280px_1fr] gap-6 lg:gap-16 items-start">
        ...
        <div className="flex flex-col gap-8 max-w-4xl">
          ...
          <p className="text-sm sm:text-lg text-[#55696a] leading-relaxed max-w-3xl font-normal">
            الجيل الجديد لم يعد ينتظر تمويلاً أو مختبراً تقليدياً لكي يبحث؛ حاسوب او هاتف مع واجهة AI يكفي ليجعله مختبراً لشخص واحد. لكن الويب العربي مهدد بفخين: إما أن تضيع هذه الاكتشافات الفردية العميقة في أرشيف المحادثات الخاصة او يخضع لنظرية الأنترنيت الميت !، أو أن تتحول المنصات إلى مكب لغثاء الـ  AI السطحي (AI Slop). <strong className="text-[#222f30] font-semibold">JEMO هي منصة التوثيق والتدقيق للاكتشافات المتقدمة في النظم والبرمجة والذكاء الاصطناعي</strong> — نلتقط نتائجك ونحميها بمعيار التحقق البشري الصارم (Proof of Work).
          </p>
