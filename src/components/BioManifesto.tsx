    ...
    >
      <div className="max-w-7xl mx-auto grid lg:grid-cols-[280px_1fr] gap-10 lg:gap-16 items-start">
        ...
        <div className="flex flex-col gap-8 max-w-4xl">
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-normal leading-[1.14] tracking-tight font-kufi text-[#222f30]">
          ...
          <p className="text-base sm:text-lg text-[#55696a] leading-relaxed max-w-3xl font-normal">
